<template>
    <div>
                        ...
                        <div class="box-header with-border list-business-box">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6 col-md-6 col-lg-7 mobl-btn-block text-right">
                                    ...
                                    <b-button v-b-modal.addCategory variant="success" size="lg">Add Category</b-button>
                                    <b-button v-b-modal.addSubCategory variant="success" size="lg">Add SubCategory</b-button>
                                    <!-- Modal -->
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered table-hover">
                                    ...
                                    <tr  v-for="(list, index) in listing" v-if="listing.length && !loadingStart" >
                                        ...
                                        <td class="list-business">
                                            <span>{{list.long_desc}}</span>
                                        </td>

                                        <td width="150">
                                            <div class="actions action-edit text-center">
                                                <a href="#" v-b-modal.addCategory  @click="updateCategory(list)"><i
                                                    class="fa fa-fw fa-edit"></i></a>
                                                <a href="#" v-b-modal.deleteRecord @click="deleteCategory(list)">
        ...
        <add-category-modal  :list="list" @call-list="onCallList"></add-category-modal>
